...
import { Bell, Lightbulb, Volume2, Zap } from "lucide-react";
...
const NUDGE_TYPES: {
  ...
  { settingKey: "nudge_overdue_alert", label: "Overdue tasks", description: "Alert when tasks are past their due date" },
  { settingKey: "nudge_deadline_approaching", label: "Approaching deadlines", description: "Warn when a deadline is within 24 hours" },
  { settingKey: "nudge_stale_tasks", label: "Stale tasks", description: "Notify about tasks pending for 14+ days" },
  { settingKey: "nudge_empty_today", label: "Empty today", description: "Remind when no tasks are planned for today" },
  { settingKey: "nudge_overloaded_day", label: "Overloaded day", description: "Warn when today exceeds your daily capacity" },
];
...
function NudgeSettings() {
  ...
  return (
    <section>
      ...
      <div className="space-y-4 max-w-md">
        <SettingRow label="Enable smart nudges" description="Proactive alerts based on your task data (no AI needed)">
          <Toggle
            enabled={enabled}
...
function QuickCaptureSettings() {
  ...
  return (
    <section>
      ...
      <div className="space-y-4 max-w-md">
        <SettingRow label="Enable quick capture" description="Register a global hotkey to show the capture window">
          <Toggle
            enabled={enabled}
