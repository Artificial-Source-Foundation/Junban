...
- Updated npm and Rust dependency locks to pick up patched versions for current Dependabot security alerts.
...
- Linux installer now supports `--choose` for users who want to pick `.deb` or AppImage interactively.
