...
- `docs/reference/plugins/README.md`
- `docs/reference/plugins/API.md`
- `docs/reference/plugins/EXAMPLES.md`

## Scope Boundary

Keep this document focused on **internal runtime architecture** (`src/plugins/**`), including loader behavior, sandbox boundaries, policy enforcement, and cleanup invariants.

Keep plugin-author onboarding, API usage, and copy-paste examples in:
