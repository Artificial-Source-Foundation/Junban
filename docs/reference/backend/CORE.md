...
Boundary note: this document covers domain/service behavior in `src/core/**`. Persistence schema and backend implementation details live in [`DATABASE.md`](DATABASE.md) and [`STORAGE.md`](STORAGE.md).
