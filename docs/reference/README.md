...
| Understand backend startup/runtime architecture   | [`../guides/ARCHITECTURE.md`](../guides/ARCHITECTURE.md)                                                                                                                    |
| Understand parser, AI, voice, and MCP internals   | [`backend/PARSER.md`](backend/PARSER.md), [`backend/AI.md`](backend/AI.md), [`backend/VOICE.md`](backend/VOICE.md), [`backend/MCP.md`](backend/MCP.md)                    |
| Understand CLI usage and internals                | [`../how-to/use-cli.md`](../how-to/use-cli.md), [`backend/CLI.md`](backend/CLI.md)                                                                                         |
