...
> This document is the **plugin-author API contract**. For internal plugin runtime architecture (loader/sandbox/policy internals), see `docs/reference/backend/PLUGINS.md`.
