...
Seven progressively complex examples showing how to build Junban plugins.

This page is author-facing. For plugin runtime internals (loader/sandbox/policy/cleanup), see `docs/reference/backend/PLUGINS.md`.
